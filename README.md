...
2. Descarga el módulo de [aquí](https://github.com/pagantis/pagamastarde-opencart/releases/download/1.0.0/pagamastarde-opencart.zip)
...
El manual de instalación y uso del módulo se puede consultar [aquí](https://github.com/pagantis/pagamastarde-opencart/releases/download/1.0.0/Guide.pdf).
